...
IF OBJECT_ID('dbo.ufn_GetLatestPeriod_COLLECTIONS_FACT','FN') IS NOT NULL
	DROP FUNCTION ufn_GetLatestPeriod_COLLECTIONS_FACT;
GO
...
select [VBM].dbo.ufn_GetLatestPeriod_COLLECTIONS_FACT(N'')